        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            SectionPanel(title: "Current State", icon: "switch.2") {
                LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 10) {
                    ...
                    CompactStat(title: "App Trust", value: store.appTrustSnapshot?.summary ?? store.appTrustText, icon: "checkmark.shield")
                    CompactStat(title: "Host App", value: store.systemExtensionInstallSnapshot?.hostText ?? "Not checked", icon: "app")
                    CompactStat(title: "Bundled Ext", value: store.systemExtensionInstallSnapshot?.bundledText ?? "Not checked", icon: "shippingbox")
                    CompactStat(title: "Active Ext", value: store.systemExtensionInstallSnapshot?.activeText ?? "Not checked", icon: "bolt.badge.checkmark")
